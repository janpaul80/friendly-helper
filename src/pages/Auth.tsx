        ...
        <div className="bg-[#111] border border-white/10 rounded-2xl p-8">
          ...
          <div className="space-y-3 mb-6">
            <button
              ...
              className="w-full flex items-center justify-center gap-3 bg-white hover:bg-gray-100 text-gray-900 py-3 rounded-lg font-medium transition-all disabled:opacity-50"
            >
              {oauthLoading === 'google' ? (
            ...
            <button
              ...
              disabled={oauthLoading !== null}
              className="w-full flex items-center justify-center gap-3 bg-[#24292e] hover:bg-[#2f363d] text-white py-3 rounded-lg font-medium transition-all disabled:opacity-50"
            >
              {oauthLoading === 'github' ? (
                <RefreshCw className="w-5 h-5 animate-spin" />
              ) : (
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 bg-[#111] text-gray-500">or continue with email</span>
            </div>
          </div>
