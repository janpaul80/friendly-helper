...
async function test() {
    // Trying the "Untitled Key" from your screenshot which seemed to have broad permissions
    ...
    console.log('Testing AGAIN with same key to see if manual fix worked...');
