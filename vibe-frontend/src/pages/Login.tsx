        ...
        <div className="min-h-screen bg-black flex items-center justify-center p-6 text-white font-sans">
            <div className="bg-gray-900 p-10 rounded-2xl w-full max-w-md border border-gray-800">
                ...
                <p className="text-gray-400 text-center mb-8">
                    {isSignUp ? 'Start building your dream app today' : 'Sign in to your HeftCoder account'}
                </p>

                <div className="space-y-4">
                    <button
                        onClick={() => handleOAuthLogin('google')}
                        className="w-full flex items-center justify-center gap-3 bg-gray-800 hover:bg-gray-700 py-3 rounded-lg transition border border-gray-700 font-medium"
                    >
